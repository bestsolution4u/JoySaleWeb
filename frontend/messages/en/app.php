...
return [
    ...
    "What is your expectation and other details"=>"What is your expectation anddetails?",
    ...
    "Start earning by selling or buying stuffs nearer to your locality by using this great online classifieds."=>"Get started with ads on Joysale. Discover great stuff from your neighbours now!",
    ...
    "Your forget password request processed successfully."=>"You have successfully reset your password!",
    ...
    "If you have business inquiries or other questions, please fill out the following form to contact us. Thank you."=>"Advertise on Joysale and become trusted with neighbors. Contact us.",
    ...
    "To be a verified seller, please add your mobile number, email address and connect with your facebook. Buyers will be more interested to talking to the verified users."=>"Become a Joysale verified authoritative seller today. Increase your customers trust by updating your mobile no, email and Facebook account today.",
    ...
    "allows you to highlight your listing with two different options to reach more number of buyers. You can choose the appropriate option for your listings. Urgent listings gets more leads from buyers and featured listings shows at various places of the website to reach more buyers."=>"Set up your product sale on fire with powerful options from Joysale. Close more deals, and catch more valid prospects than ever using our urgent and featured ad services.",
    ...
    "Instant buy details"=>"Quick buying infor",
    "Note"=>"Note",
    "Paypay Id"=>"PayPal ID",
